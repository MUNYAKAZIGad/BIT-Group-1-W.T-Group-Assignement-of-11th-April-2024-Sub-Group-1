...
$connection = new mysqli("localhost", "root", "", "bityeartwo2024");
                                    ...
                                    <ul class="navbar-nav">
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="logout.php" class="btn btn-danger">Logout</a></li>
                                        ...
                                        <li> <!--I added this in my style-->
                                            ...
                                            <form class="d-flex" role="search">
                                                <div style="margin-left: 20px; text-align:center;"><h1>Hello <?php echo $email; ?></h1></div>
                                            </form>
                                            <!--</div>-->
